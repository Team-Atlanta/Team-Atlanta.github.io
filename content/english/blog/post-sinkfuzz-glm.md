...
*Vulnerabilities reached vs. exploited for all configurations. Gondar configurations (blue) cluster in the upper-right; baselines (gray) sit in the lower-left. Ablations (orange) show the impact of removing individual components.*
...
### Finding: LLMs and Fuzzers Are Complementary, Not Interchangeable
...
### Finding: Open-Source Models Deliver Near-Flagship Performance
