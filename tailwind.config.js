    ...
    extend: {
      colors: {
        ...
        darkmode: {
          ...
          muted: theme.colors.darkmode.text_color.muted,
        ...
        gradient: {
          from: theme.colors.default.theme_color.primary,
          via: theme.colors.default.theme_color.secondary,
          to: theme.colors.default.theme_color.accent,
        },
      },
      fontSize: {
        base: font_base + "px",
